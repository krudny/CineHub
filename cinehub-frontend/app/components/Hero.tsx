            ...
            <div className="absolute w-full lg:w-3/5 h-screen flex justify-center items-center z-20">
                <div className="mx-16">
                    ...
                    <div className="flex gap-4 my-4 font-oswald">
                        <p className="text-white text-lg lg:text-2xl">Rating: {props.rating}</p>
                        <p className="text-white text-lg lg:text-2xl">Duration: {props.duration}</p>
                    ...
                    <div className="flex gap-6 mt-10">
                        <button
                            className="flex justify-center items-center px-4 py-3 bg-orange-500 rounded-3xl transition duration-200 ease-in-out hover:bg-orange-600">
                        ...
                        <button
                            className="flex justify-center items-center px-4 py-3 bg-neutral-100 rounded-3xl transition duration-200 ease-in-out hover:bg-neutral-300">
